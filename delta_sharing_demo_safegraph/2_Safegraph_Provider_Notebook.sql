...
-- MAGIC %md
-- MAGIC 
-- MAGIC # Data Provider | [SafeGraph](https://www.safegraph.com/?utm_source=juntodemonotebook&utm_medium=referral&utm_campaign=junto_launch_demonotebook201911)<img src="https://i.ibb.co/vdNHFZN/deltasharingimage.png" width="55" height="60" />
-- MAGIC   
...
-- MAGIC 2. Unity Catalog’s security model is based on standard ANSI SQL, to grant permissions at the level of databases, tables, views, rows and columns **UI COMING SOON </b> <br>
